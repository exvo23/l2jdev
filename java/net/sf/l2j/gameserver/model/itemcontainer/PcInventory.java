...
public class PcInventory extends Inventory
{
	 ...
	 * @return ItemInstance corresponding to the new item or the updated item in inventory
	 */
	public ItemInstance addEnchantedItem(String process, int itemId, int itemCount, int enchantLevel, Player actor, L2Object reference)
	{
	...
	public boolean validateCapacity(int slots, boolean questItem)
	{
		...
		return _questSlots + slots <= Player.getQuestInventoryLimit();
	}
