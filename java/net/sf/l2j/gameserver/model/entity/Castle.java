...
public class Castle
{
	...
	public void setOwner(L2Clan clan)
	{
		...
		if (_ownerId > 0 && (clan == null || clan.getClanId() != _ownerId))
		{
			...
			if (oldOwner != null)
			{
				...
				Broadcast.gameAnnounceToOnlinePlayers(oldOwner.getName() + " has lost " + getName() + " castle!");
	...
	public void removeOwner(L2Clan clan)
	{
		if (clan != null)
		{
			...
			clan.setCastle(0);
			Broadcast.gameAnnounceToOnlinePlayers(clan.getName() + " has lost " + getName() + " castle!");
	...
	private void updateOwnerInDB(L2Clan clan)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			if (clan != null)
			{
				...
				Broadcast.gameAnnounceToOnlinePlayers(clan.getName() + " has taken " + getName() + " castle!");
