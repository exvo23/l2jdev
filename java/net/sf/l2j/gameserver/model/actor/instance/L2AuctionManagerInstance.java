...
import Dev.MarketShop.AuctionItem;
import Dev.MarketShop.AuctionTable;
...
public class L2AuctionManagerInstance extends L2NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("addit2"))
		{
			try
			{
				...
				int costId = 0;
				if (costitemtype.equals("TKT_Donate"))
				{
					costId = 9506;
				}
	...
	private void showAddPanel2(Player player, int itemId)
	{
		...
		html += "<br><combobox width=120 height=17 var=ebox list=TKT_Donate;>";
	...
	private void showAddPanel(Player player, int page)
	{
		...
		{
			if (item.getItemId() != 9309 && item.isTradable())
			{
				temp.add(item);
	...
	public String getHtmlPath(int npcId, int val)
    {
        ...
        return "data/html/mods/MarketShop/" + pom + ".htm";
    }
}
