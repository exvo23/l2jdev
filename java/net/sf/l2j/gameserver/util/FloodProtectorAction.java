...
public final class FloodProtectorAction
{
	...
	public boolean tryPerformAction(final String command)
	{
		...
		_nextGameTick = (int) (curTick + _config.FLOOD_PROTECTION_INTERVAL);
		_logged = false;
		_count.set(0);
	...
	private void banAccount()
	{
		if (_client.getActiveChar() != null)
		{
			_client.getActiveChar().setPunishLevel(Player.PunishLevel.ACC, _config.PUNISHMENT_TIME);
	...
	private void jailChar()
	{
		if (_client.getActiveChar() != null)
		{
			_client.getActiveChar().setPunishLevel(Player.PunishLevel.JAIL, _config.PUNISHMENT_TIME);
