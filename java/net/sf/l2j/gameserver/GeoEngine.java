...
public class GeoEngine extends GeoData
{
	...
	/**
	 * @see net.sf.l2j.gameserver.GeoData#canSeeTargetDebug(net.sf.l2j.gameserver.model.actor.Player, net.sf.l2j.gameserver.model.L2Object)
	 */
	@Override
	public boolean canSeeTargetDebug(Player gm, L2Object target)
	{
		// comments: see above
		int z = gm.getZ() + 45;
		int z2 = target.getZ() + 45;
	...
	/**
	 * @see net.sf.l2j.gameserver.GeoData#addGeoDataBug(net.sf.l2j.gameserver.model.actor.Player, java.lang.String)
	 */
	@Override
