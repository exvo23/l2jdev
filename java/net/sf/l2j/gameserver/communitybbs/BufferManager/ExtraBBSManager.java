 ...
 *
 */
public class ExtraBBSManager extends BaseBBSManager
{
	@Override
	public void parseCmd(String command, Player activeChar)
	{
		if (command.startsWith("_bbsextra"))
		{
	...
	public static ExtraBBSManager getInstance()
	{
	...
	{
		protected static final ExtraBBSManager INSTANCE = new ExtraBBSManager();
	}
}
