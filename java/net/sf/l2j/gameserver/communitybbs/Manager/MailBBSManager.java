...
public class MailBBSManager extends BaseBBSManager
{
	...
	private void showMailList(Player activeChar, int page, String type)
	{
		showMailList(activeChar, page, type, "", "");
	}
	
	private void showMailList(Player activeChar, int page, String type, String sType, String search)
	{
		List<Mail> letters;
	...
	private void setLetterLocation(Player activeChar, int letterId, String location)
	{
