...
public class MultisellData
{
	 ...
	 */
	private ListContainer generateMultiSell(String listName, boolean inventoryOnly, Player player, double taxRate)
	{
	...
	public void separateAndSend(String listName, Player player, boolean inventoryOnly, double taxRate)
	{
