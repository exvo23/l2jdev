...
public class RaidBossPointsManager
{
	...
	public final static void updatePointsInDB(Player player, int raidId, int points)
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
	...
	public final static void addPoints(Player player, int bossId, int points)
	{
	...
	public final static Map<Integer, Integer> getList(Player player)
	{
