...
import net.sf.l2j.gameserver.model.actor.Player;
 ...
 public class OlyClassDamageManager
 {
 	...
 	public static double getDamageMultiplier(Player attacker, Player attacked)
 	{
		...
		if (Config.ENABLE_OLY_CLASS_DAMAGES_LOGGER)
		{
			_log.info("Oly - ClassDamageManager -");
			_log.info("Oly - ClassDamageManager - Attacker: "+attacker.getName()+" Class: "+getNameById(attacker.getClassId().getId())+" ClassId: "+attacker.getClassId().getId()+" isMage: "+attacker.isMageClass()+" mult: "+attackerMulti);
			_log.info("Oly - ClassDamageManager - Attacked: "+attacked.getName()+" Class: "+getNameById(attacked.getClassId().getId())+" ClassId: "+attacked.getClassId().getId()+" isMage: "+attacked.isMageClass()+" mult: "+attackedMulti);
			_log.info("Oly - ClassDamageManager - FinalMultiplier: "+output);
			_log.info("Oly - ClassDamageManager -");
		}
