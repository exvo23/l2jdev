...
public class MultiSellChoose extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		final L2Npc merchant = player.getCurrentFolkNPC();
		if (!player.isGM() && !player.isCMultisell() && ((merchant == null) || !merchant.canInteract(player)))
			return;
	...
	private void doExchange(Player player, L2Npc merchant, Entry templateEntry, boolean applyTaxes, boolean maintainEnchantment, int enchantment)
	{
