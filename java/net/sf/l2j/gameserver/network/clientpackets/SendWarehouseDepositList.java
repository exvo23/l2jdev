	...
	protected void runImpl()
	{
		...
		for (WarehouseItem i : _items)
		{
			...
			if (item == null)
			{
				...
				//Util.handleIllegalPlayerAction(player, "Error depositing a warehouse object for char [" + player.getName() + "] (validity check)", 3);
				return;
			}
		...
		for (WarehouseItem i : _items)
		{
			...
			WharehouseLog.auditGMAction(player.getName(), warehouse.getName(), i.getObjectId(), oldItem, oldItem.getEnchantLevel());
