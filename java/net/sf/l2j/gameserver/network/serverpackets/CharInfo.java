...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeS(_activeChar.isVip() ? "[VIP]-" + _activeChar.getName() : _activeChar.getName());
		...
		writeD(_activeChar.visual_hair > 0 ? _activeChar.visual_hair : _inv.getPaperdollItemId(Inventory.PAPERDOLL_HAIRALL));
		...
		writeD(_activeChar.visual_boots > 0 ? _activeChar.visual_boots : _inv.getPaperdollItemId(Inventory.PAPERDOLL_FEET));
		writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_BACK));
		writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_RHAND));
		writeD(_activeChar.visual_hair > 0 ? _activeChar.visual_hair : _inv.getPaperdollItemId(Inventory.PAPERDOLL_HAIR));
