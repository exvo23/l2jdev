...
public class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_activeChar.visual_test_hair > 0 ? _activeChar.visual_test_hair : (_activeChar.visual_hair > 0 ? _activeChar.visual_hair : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_HAIRALL)));
		...
		writeD(_activeChar.visual_test_gloves > 0 ? _activeChar.visual_test_gloves : (_activeChar.visual_gloves > 0 ? _activeChar.visual_gloves : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_GLOVES)));
		writeD(_activeChar.visual_test_chest > 0 ? _activeChar.visual_test_chest : (_activeChar.visual_chest > 0 ? _activeChar.visual_chest : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CHEST)));
		writeD(_activeChar.visual_test_legs > 0 ? _activeChar.visual_test_legs : (_activeChar.visual_legs > 0 ? _activeChar.visual_legs : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_LEGS)));
		writeD(_activeChar.visual_test_boots > 0 ? _activeChar.visual_test_boots : (_activeChar.visual_boots > 0 ? _activeChar.visual_boots : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_FEET)));
		writeD(_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_BACK));
		writeD(_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_RHAND));
		writeD(_activeChar.visual_test_hair > 0 ? _activeChar.visual_test_hair : (_activeChar.visual_hair > 0 ? _activeChar.visual_hair : _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_HAIR)));
		...
		writeD(_activeChar.visual_test_gloves > 0 ? _activeChar.visual_test_gloves : (_activeChar.visual_gloves > 0 ? _activeChar.visual_gloves : _activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_GLOVES)));
		...
		writeD(_activeChar.visual_test_legs > 0 ? _activeChar.visual_test_legs : (_activeChar.visual_legs > 0 ? _activeChar.visual_legs : _activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_LEGS)));
		writeD(_activeChar.visual_test_boots > 0 ? _activeChar.visual_test_boots : (_activeChar.visual_boots > 0 ? _activeChar.visual_boots : _activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_FEET)));
